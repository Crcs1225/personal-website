  ...
  <div class="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
    <div class="flex items-center gap-2">
      ...
      <span class="text-sm font-medium text-green-400">
        Open to AI Product & Software Roles
      </span>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="space-y-3">
        ...
        <div class="flex flex-wrap gap-2">
          <span class="text-xs px-3 py-1 border border-purple-500/30 rounded-md bg-purple-500/10 text-purple-300">OpenAI API</span>
          <span class="text-xs px-3 py-1 border border-yellow-500/30 rounded-md bg-yellow-500/10 text-yellow-300">Hugging Face</span>
          <span class="text-xs px-3 py-1 border border-orange-500/30 rounded-md bg-orange-500/10 text-orange-300">TensorFlow</span>
          <span class="text-xs px-3 py-1 border border-blue-500/30 rounded-md bg-blue-500/10 text-blue-300">AI Agents</span>
          <span class="text-xs px-3 py-1 border border-gray-500 rounded-md bg-gray-700 text-gray-300">Prompt Engineering</span>
        </div>
      </div>
